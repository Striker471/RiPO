...
# import numpy as np
# import math
# # video =cv2.VideoCapture(r'scena1.mp4')
# # video =cv2.VideoCapture(r'scena2.mp4')
# # video =cv2.VideoCapture(r'scena3.mp4')
# # video =cv2.VideoCapture(r'scena4.mp4')
# # video =cv2.VideoCapture(r'scena5.mp4')
# # video =cv2.VideoCapture(r'scena6.mp4')
# # video =cv2.VideoCapture(r'scena7.mp4')
# # video =cv2.VideoCapture(r'scena8.mp4')
# video =cv2.VideoCapture(r'scena9.mp4')
# # video =cv2.VideoCapture(r'scena10.mp4')
# #video =cv2.VideoCapture(r'scena11.mp4')
#
#
# def print_hi(name):
